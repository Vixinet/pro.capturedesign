	...
	$language = array(
		...
		"work_projects" => array(
			...
			array(
				...
				"project_projects" => "construction business: residential districts, raw-houses",
				"project_services" => "interior design; realistic exterior & interior 3D visualizations",
				"project_result" => "elegant interior design for the upcoming apartments;<br/>impressive marketing materials for the estate;<br/>boost for marketing & sales",
			),
